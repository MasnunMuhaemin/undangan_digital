const Maps = () => {
    return (
      <div className="flex text-tertiary mobile-425:mt-16  relative">
        {/* Container Utama */}
        <div className="w-[90%] max-w-3xl p-5 rounded-lg">
          {/* Lokasi */}
          <div className="mt-8 flex items-center">
            {/* Teks dan Panah di Kiri */}
            <div className="pr-4 flex flex-col justify-center w-1/2">
              <h2 className="font1 mb-11 text-3xl text-center md:text-left">
                LOKASI
              </h2>
              <p className="w-36 font1 mb-9 text-[10px] text-center md:text-left">
            ...
            {/* Kotak Map di Kanan */}
            <div className="ml-7 mt-20 flex justify-center items-center w-1/2 z-10">
              <div>
        ...
        <div className="absolute top-0 right-0 mt-5">
          <img
            src="/images/ornamen/ornamen7.png" 
            alt="Ornamen7"
